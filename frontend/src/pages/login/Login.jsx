          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label className="label">
                <span className="text-base label-text-alt">Password</span>
              </label>
            ...
            <Link to="/signup" className="text-sm hoverunderline hover:text-blue-600 mt-2 inline-block">{"Dont't"} have an account?</Link>
            <div>
...
//             <a href="#" className="text-sm hoverunderline hover:text-blue-600 mt-2 inline-block">{"Dont't"} have an account?</a>
//             <div>
