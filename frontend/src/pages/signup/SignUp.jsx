...
//               <span className="text-base label-text">Full Name</span>
//             </label>
//             <input type="text" placeholder="Kunal Pai" className="w-full input input-bordered h-10" />
//           </div>
...
//           <span className="text-base label-text">Username</span>
//           </label>
//           <input type="text" placeholder="KP" className="w-full input input-bordered h-10" />
//           </div>
